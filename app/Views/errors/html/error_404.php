...
<meta charset="utf-8">
	...
	<meta name="description" content="Abbauf GIS - 404" />
	<meta property="og:title" content="Abbauf GIS - 404" />
	<meta property="og:description" content="Abbauf GIS - 404" />
	<meta property="og:image" content="<?php echo base_url();?>/images/favicon.png" />
	<meta name="format-detection" content="telephone=no">
	<!-- PAGE TITLE HERE -->
	<title>Abbauf GIS - 404</title>
	<!-- FAVICONS ICON -->
...
***********************************-->
<!-- Required vendors -->
<script src="<?php echo base_url();?>/my-vendor/global/global.min.js"></script>
