    ...
    <div class="row">
        ...
        <div class="col-xl-4">
            ...
            <div class="small-card-poi mb-3 all-user-registration">
                <div class="row d-flex align-items-center pt-3 pb-3">
                    <img src="<?php echo base_url() ?>/icons/dashboard/shp.svg" alt="shp" class="d-block mr-1">
                    <h6 class="m-0 font-inter ml-3" style="color: #000;">All SHP</h6>
                </div>
                <div class="row d-flex align-items-end">
                    <h2 id="shp_count" class="m-0 font-inter" style="color: #000;">123.987</h2>
        ...
        <div class="col-xl-4">
            ...
            <div class="small-card-poi mb-3 all-user-registration">
                ...
                <div class="row d-flex align-items-end">
                    <h2 id="shp_count2" class="m-0 font-inter" style="color: #000;">123.987</h2>
                    <p class="m-0 font-inter pl-2 userText" style="font-weight: 500; color: #000;">SHP</p>
                </div>
            </div>
            <!-- End Of Side Card All User Registration -->
        ...
        <div class="col-xl-4">
            ...
            <div class="small-card-poi mb-3 all-user-registration">
                ...
                <div class="row d-flex align-items-end">
                    <h2 id="shp_count3" class="m-0 font-inter" style="color: #000;">123.987</h2>
                    <p class="m-0 font-inter pl-2 userText" style="font-weight: 500; color: #000;">SHP</p>
                </div>
            </div>
            <!-- End Of Side Card All User Registration -->
                ...
                <table class="table text-left">
                    <thead class="font-kanit">
                        <tr class="header-table">
                            <th scope="col" style="width: 250px">SHP Name</th>
            ...
            <form action="" method="post" id="shp_add">
                <div class="modal-body font-nunito">
                    <div class="modal-input-field">
                        ...
                        <input id="shp-name" name="name" type="text" class="form-control" placeholder="shp name">
                    </div>
                    <div class="modal-input-field">
