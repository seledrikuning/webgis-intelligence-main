...
<div class="content-container">
    ...
    <div class="div table-card-poi">
        <div class="d-flex justify-content-between align-items-center">
            <h4 class="pr-5 pl-5 pt-4 pb-3 font-kanit">List POI</h4>
            <button class="mr-5 dashboard-button" id="add-package-btn-POI">
        ...
        <div class="table-container-poi pl-5 pr-5 pb-4">
            <!-- Bootstrap Table -->
            <table class="table text-left">
                <thead class="table-blue font-kanit">
                    <tr>
                        <th scope="col" style="font-weight: 300; width: 250px">POI Name</th>
                        <th scope="col" class="text-center" style="font-weight: 300; width: 250px">Total POI</th>
