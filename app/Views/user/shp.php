...
<div class="content-container">
        ...
        <div class="col-xl-4">
            ...
            <div class="small-card-poi mb-3 all-user-registration">
                <div class="row d-flex align-items-center pt-3 pb-3">
                    ...
                    <h6 class="m-0 font-inter ml-3" style="color: #000;">All SHP</h6>
                </div>
                <div class="row d-flex align-items-end">
                    <h2 class="m-0 font-inter" style="color: #000;">123.987</h2>
                    <p class="m-0 font-inter pl-2 userText" style="font-weight: 500; color: #000;">SHP</p>
                </div>
            </div>
    ...
    <div class="div card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h4 class="font-kanit">List SHP</h4>
            <button class="dashboard-button" id="add-shp-user">
        ...
        <div class="card-body">
            <div class="table-container-poi">
                <!-- Bootstrap Table -->
                <table class="table text-left">
                    <thead class="table-blue font-kanit">
                        <tr>
                            <th scope="col" style="font-weight: 300; width: 250px">SHP Name</th>
                            <th scope="col" class="text-center" style="font-weight: 300; width: 250px">Username Upload</th>
                            <th scope="col" class="text-center" style="font-weight: 300; width: 250px">Status</th>
                            <th scope="col" class="text-center" style="font-weight: 300; width: 250px">Action</th>
                        </tr>
                    </thead>
                    <tbody id="all-shp">
                        <tr>
                            <td class="font-kanit " style="color: #3F779B;">Alfamart</td>
                            <td class="text-center" style="color: #000; font-size:14px; font-weight:500;">Gilang</td>
                            <td class="text-center" style="color: #000; font-size:14px; font-weight:500;">Active</td>
                            <td class="text-center d-flex justify-content-center">
                                <button id="edit-shp" type="button" class="dashboard-button-yellow dashboard-button-sm color-white mr-2">
                        ...
                        <tr>
                            ...
                            <td class="text-center" style="color: #000; font-size:14px; font-weight:500;">Noval</td>
...
<!-- ======== modal add SHP ======== -->
<div class="modal fade" id="add-shp-user-modal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-kanit" id="myModalLabel">Add SHP</h5>
                <button type="button" class="close close-add-shp-user" id="close-add-shp-user" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body font-nunito">
                <div class="modal-input-field">
                    <label for="shp-name">SHP Name</label>
                    <input id="shp-name" type="text" class="form-control" placeholder="shp name">
                </div>
                <div class="modal-input-field" style="display: none;">
                    <label for="username-input">Username Upload</label>
                    <input id="username-input" type="text" class="form-control" placeholder="input username">
                </div>
                <div class="modal-input-field">
                    <label for="shp-status">SHP Status</label>
                    <select class="form-control" name="status" id="package-status">
                        <option value="t">Active</option>
                        <option value="f">Not Active</option>
                    </select>
                    <!-- <select class="" id="shp-status">
...
<!-- Modal Edit SHP -->
<div class="modal fade" id="modal-edit-SHP" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-kanit" id="myModalLabel">Edit SHP</h5>
            ...
            <form action="" method="post" id="shp_add">
                <div class="modal-body font-nunito">
                    <div class="modal-input-field">
                        <label for="package-name">SHP Name</label>
                        <input id="package-name" type="text" class="form-control" placeholder="SHP name">
                    </div>
                    <div>
                        <div class="modal-input-field" style="display: none;">
                            <label for="package-price">Username Input</label>
                            <input id="package-price" type="number" class="form-control" placeholder="Username">
                        </div>
                        <div class="m">
...
<div class="modal fade" id="modal-delete-confirmation" tabindex="-1" aria-labelledby="modalDeleteConfirmationLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title font-kanit" id="modalDeleteConfirmationLabel">Delete SHP</h5>
                <button type="button" class="close close-delete-confirmation" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body font-nunito">
                <h5 class="text-center">Are you sure you'd like to delete shp?</h5>
            </div>
            <div class="modal-footer">
