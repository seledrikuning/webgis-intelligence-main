...
exports.isCesiumProjection = function (projection) {
  ...
  var is4326 = projection.getCode() === 'EPSG:4326';
...
var olUseNewCoordinates = function () {
  var tileSource = new ol_source_js__WEBPACK_IMPORTED_MODULE_1__.Tile({
...
= /*#__PURE__*/function () {
  ...
  _proto.getTileCredits = function getTileCredits(x, y, level) {
    ...
    return (0,_core_js__WEBPACK_IMPORTED_MODULE_2__.attributionsFunctionToCredits)(attributionsFunction, zoom, center, extent);
  }
  /**
   * @export
   * @override
