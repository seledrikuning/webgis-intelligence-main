...
define([
...
], function (e, t, r, n, a, u, i, o, c, s, p, m, d) {
  "use strict";
  function f(n) {
    const u = n.frustum,
      i = n.orientation,
    ...
    u instanceof a.PerspectiveFrustum
      ...
      : u instanceof a.OrthographicFrustum &&
        ((s = 1), (p = a.OrthographicFrustum.packedLength)),
      (this._frustumType = s),
  ...
  f.pack = function (n, u, i) {
    ...
    return (
      (u[i++] = o),
      0 === o
        ? (a.PerspectiveFrustum.pack(c, u, i),
          (i += a.PerspectiveFrustum.packedLength))
        : (a.OrthographicFrustum.pack(c, u, i),
  ...
  const h = new a.PerspectiveFrustum(),
    l = new a.OrthographicFrustum(),
    g = new t.Quaternion(),
    _ = new r.Cartesian3();
  return (
    (f.unpack = function (n, u, i) {
      u = e.defaultValue(u, 0);
      const o = n[u++];
      let c;
      0 === o
        ? ((c = a.PerspectiveFrustum.unpack(n, u, h)),
          (u += a.PerspectiveFrustum.packedLength))
        : ((c = a.OrthographicFrustum.unpack(n, u, l)),
          (u += a.OrthographicFrustum.packedLength));
      const s = r.Cartesian3.unpack(n, u, _);
      u += r.Cartesian3.packedLength;
      const p = t.Quaternion.unpack(n, u, g),
    ...
    function (t, r) {
      return e.defined(r) && (t = f.unpack(t, r)), f.createGeometry(t);
    }
  );
});
