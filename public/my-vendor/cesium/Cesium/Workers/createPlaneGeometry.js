...
define([
...
], function (t, e, n, r, a, o, i, m, u, c, p) {
  "use strict";
  function s(e) {
  ...
  (s.packedLength = i.VertexFormat.packedLength),
    (s.pack = function (e, n, r) {
      return (
  ...
  const y = new i.VertexFormat(),
    f = { vertexFormat: y };
  s.unpack = function (e, n, r) {
    n = t.defaultValue(n, 0);
    const a = i.VertexFormat.unpack(e, n, y);
    return t.defined(r)
      ? ((r._vertexFormat = i.VertexFormat.clone(a, r._vertexFormat)), r)
      : new s(f);
  };
  const l = new n.Cartesian3(-0.5, -0.5, 0),
  ...
  return (
    ...
    function (e, n) {
      return t.defined(n) && (e = s.unpack(e, n)), s.createGeometry(e);
    }
  );
});
