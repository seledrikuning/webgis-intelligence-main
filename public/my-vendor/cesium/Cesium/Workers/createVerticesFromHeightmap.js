...
define([
  ...
  const k = new e.Cartesian3(),
    ...
    I = new e.Cartesian3(),
    b = new e.Cartesian3();
  w.computeVertices = function (o) {
    const f = Math.cos,
      u = Math.sin,
      c = Math.sqrt,
      d = Math.atan,
      h = Math.exp,
      m = r.CesiumMath.PI_OVER_TWO,
      g = r.CesiumMath.toRadians,
      p = o.heightmap,
      x = o.width,
      U = o.height,
      T = o.skirtHeight,
      M = T > 0,
      V = a.defaultValue(o.isGeographic, !0),
      v = a.defaultValue(o.ellipsoid, e.Ellipsoid.WGS84),
      A = 1 / v.maximumRadius,
      B = e.Rectangle.clone(o.nativeRectangle),
      D = e.Rectangle.clone(o.rectangle);
    let S, P, E, C;
    a.defined(D)
      ...
      : ((S = B.west * A),
        ...
        (E = B.east * A),
        (C = m - 2 * d(h(-B.north * A))));
    let F = o.relativeToCenter;
    const N = a.defined(F);
    F = N ? F : e.Cartesian3.ZERO;
    const O = a.defaultValue(o.includeWebMercatorT, !1),
      R = a.defaultValue(o.exaggeration, 1),
      L = a.defaultValue(o.exaggerationRelativeHeight, 0),
      z = 1 !== R,
      H = a.defaultValue(o.structure, w.DEFAULT_STRUCTURE),
      ...
      W = a.defaultValue(
        H.elementsPerHeight,
        w.DEFAULT_STRUCTURE.elementsPerHeight
      ),
      X = a.defaultValue(H.stride, w.DEFAULT_STRUCTURE.stride),
      Z = a.defaultValue(
        H.elementMultiplier,
        w.DEFAULT_STRUCTURE.elementMultiplier
      ),
    ...
    let se, le;
    O &&
      ((se = l.WebMercatorProjection.geodeticLatitudeToMercatorAngle(P)),
      (le =
        1 / (l.WebMercatorProjection.geodeticLatitudeToMercatorAngle(C) - se)));
    const oe = I;
    ...
    for (let t = we; t < ke; ++t) {
      ...
      a = V ? g(a) : m - 2 * d(h(-a * A));
      let n = (a - P) / (C - P);
      n = r.CesiumMath.clamp(n, 0, 1);
      const s = t === we,
        o = t === ke - 1;
      T > 0 && (s ? (a += be * q) : o && (a -= be * q));
      const w = f(a),
        y = u(a),
        I = te * y;
      let b;
      O &&
        (b =
          (l.WebMercatorProjection.geodeticLatitudeToMercatorAngle(a) - se) *
          le);
      for (let t = ye; t < Ie; ++t) {
        let a = t;
        a < 0 && (a = 0), a >= x && (a = x - 1);
        ...
        if (1 === W) d = p[l];
          ...
          let e;
          if (((d = 0), j)) for (e = 0; e < W; ++e) d = d * Z + p[l + e];
          else for (e = W - 1; e >= 0; --e) d = d * Z + p[l + e];
        }
        (d = d * _ + Y), (ae = Math.max(ae, d)), (ie = Math.min(ie, d));
        let h = B.west + Q * a;
        V ? (h = g(h)) : (h *= A);
        let m = (h - S) / (E - S);
        m = r.CesiumMath.clamp(m, 0, 1);
        let M = i * x + a;
        if (T > 0) {
          const e = t === ye,
            n = t === Ie - 1,
    ...
    let Te, Me;
    if (
      (a.defined(D) && (Te = s.OrientedBoundingBox.fromRectangle(D, ie, ae, v)),
      N)
    ) {
      Me = new n.EllipsoidalOccluder(
        v
      ).computeHorizonCullingPointPossiblyUnderEllipsoid(F, he, ie);
    }
    const Ve = new t.AxisAlignedBoundingBox(oe, fe, F),
      ve = new n.TerrainEncoding(F, Ve, ue, ae, ne, !1, O, z, R, L),
      Ae = new Float32Array(de * ve.stride);
    let Be = 0;
    for (let e = 0; e < de; ++e)
      Be = ve.encode(Ae, Be, he[e], ge[e], me[e], void 0, pe[e], xe[e]);
    return {
      vertices: Ae,
      maximumHeight: ae,
      minimumHeight: ie,
  ...
  var U = w,
    T = f.createCommonjsModule(function (e) {
            ...
            ((t = {
              ...
              decode: function (e, s) {
                ...
                return (
                  ...
                  s.returnFileInfo &&
                    ((c.fileInfo = a(o)),
                    s.computeUsedBitDepths && (c.fileInfo.bitDepths = n(o))),
                  c
                );
              },
            }),
              ...
              if (
                ...
                if (
                  ...
                  var s = new Uint8Array(Math.ceil((a.width * a.height) / 8)),
                    l = (r = new DataView(e, t, a.mask.numBytes)).getInt16(
                      0,
                      !0
                    ),
                    o = 2,
                  ...
                  0 ==
                    (a.mask.numBytes | a.mask.numBlocksY | a.mask.maxValue) &&
            ...
            (h = {
              ...
              readSubArray: function (e, t, i, a) {
                ...
                if (i === Uint8Array) n = new Uint8Array(e, t, a);
                  ...
                  new Uint8Array(r).set(new Uint8Array(e, t, a)),
                    (n = new i(r));
                }
                return n;
              },
              ...
              readDataOneSweep: function (e, t, i) {
                ...
                if (i === Uint8Array) a = new Uint8Array(e, n, f);
                  ...
                  new Uint8Array(c).set(new Uint8Array(e, n, f)),
                    (a = new i(c));
                }
                if (a.length === l * s) t.pixels.resultPixels = a;
                  ...
                  if (s > 1)
                    ...
                    for (m = 0; m < l; m++)
                      u[m] && (t.pixels.resultPixels[m] = a[d++]);
                }
              ...
              readHuffmanTree: function (e, t) {
                ...
                for (o = 0; o < d.length; o++)
                  void 0 !== d[o] && (b = Math.max(b, d[o].first));
                (U = b >= i ? i : b),
                  b >= 30 && console.log("WARning, large NUM LUT BITS IS " + b);
                var M,
                  V,
                  v,
                  A,
                ...
                for (b = 0; b < u; b++)
                  for (T = b !== u - 1 ? s : N, U = 0; U < f; U++)
                    for (
                      ...
                      if ((p = 3 & v) > 3)
                        throw (
                          ((t.ptr += C), "Invalid block encoding (" + p + ")")
                        );
                      if (2 !== p)
                        if (0 === p) {
                          if (
            ...
            }),
            {
              decode: function (e, t) {
                ...
                if (
                  ...
                  if (r.zMax === r.zMin) h.constructConstantSurface(n);
                  else if (s >= 4 && h.checkMinMaxRanges(e, n))
                    h.constructConstantSurface(n);
                  else {
                    ...
                    if ((n.ptr++, c)) h.readDataOneSweep(e, n, l);
                      ...
                      var d = u.getUint8(1);
                      if (
                        (n.ptr++, (n.encodeMode = d), d > 2 || (s < 4 && d > 1))
                      )
                ...
                if (
                  n.pixels.resultMask &&
                  h.isValidPixelValue(r.imageType, i)
                ) {
                ...
                return (
                  (n.noDataValue = i),
                  t.returnFileInfo && (m.fileInfo = h.formatFileInfo(n)),
                  m
                );
              },
  ...
  return u(function (t, i) {
    if (t.encoding === x.LERC) {
      let e;
      try {
        e = T.decode(t.heightmap);
      } catch (e) {
        throw new o.RuntimeError(e);
      }
      if (e.statistics[0].minValue === Number.MAX_VALUE)
        throw new o.RuntimeError("Invalid tile data");
      (t.heightmap = e.pixels[0]), (t.width = e.width), (t.height = e.height);
    }
    (t.ellipsoid = e.Ellipsoid.clone(t.ellipsoid)),
      (t.rectangle = e.Rectangle.clone(t.rectangle));
    const a = U.computeVertices(t),
      n = a.vertices;
    return (
      i.push(n.buffer),
      {
