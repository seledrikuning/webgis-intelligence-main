...
define([
  ...
  function D(t, e, a, i, n, s) {
    const l = t.normals,
      d = t.tangents,
      u = t.bitangents,
      c = r.Cartesian3.normalize(r.Cartesian3.cross(a, e, P), P);
  ...
  function M(t, e, i) {
    ...
    for (h = 0; h < d.length; h += 2)
      (C = d[h].length - 3), (b += C), (_ += 2 * C), (A += d[h + 1].length - 3);
    for (b += 3, A += 3, h = 0; h < c.length; h++) {
      g = c[h];
      const t = c[h].leftPositions;
      n.defined(t)
        ? ((C = t.length), (b += C), (_ += C))
        : ((C = c[h].rightPositions.length), (A += C), (_ += C));
    }
    const w = n.defined(m);
    let v;
    w && ((v = m[0].length - 3), (b += v), (A += v), (v /= 3), (_ += 6 * v));
    const x = b + A,
    ...
    let O,
      ...
      Y = G;
    const W = v / 2,
      q = u.IndexDatatype.createTypedArray(x / 3, _);
    let j = 0;
    if (w) {
      (H = E), (k = V);
      const t = m[0];
      for (
        ...
        (H = r.Cartesian3.fromArray(t, 3 * (W - 1 - h), H)),
          ...
          o.CorridorGeometryLibrary.addAttribute(N, k, z),
          o.CorridorGeometryLibrary.addAttribute(N, H, void 0, B),
          D(M, U, Y, z, B, e),
          (I = z / 3),
          (R = I + 1),
          (O = (B - 2) / 3),
    ...
    for (
      ...
      (J = i.geodeticSurfaceNormal(r.Cartesian3.fromArray(Z, h, P), P)),
        (K = i.geodeticSurfaceNormal(r.Cartesian3.fromArray($, C - h, F), F)),
        ...
        (B -= 3);
    for (
      J = i.geodeticSurfaceNormal(r.Cartesian3.fromArray(Z, C, P), P),
      ...
      let l,
        ...
        p = E,
        b = V;
      if (((U = r.Cartesian3.fromArray(y, X, U)), n.defined(a))) {
        for (
          D(M, U, Y, void 0, B, e), B -= 3, l = R, u = S, t = 0;
          t < a.length / 3;
          t++
        )
          (m = r.Cartesian3.fromArray(a, 3 * t, m)),
            ...
            (q[j++] = u - t - 1),
            (q[j++] = u - t),
            o.CorridorGeometryLibrary.addAttribute(N, m, void 0, B),
            (p = r.Cartesian3.fromArray(N, 3 * (u - t - 1), p)),
            (b = r.Cartesian3.fromArray(N, 3 * l, b)),
            (Y = r.Cartesian3.normalize(r.Cartesian3.subtract(p, b, Y), Y)),
            D(M, U, Y, void 0, B, e),
            (B -= 3);
        (m = r.Cartesian3.fromArray(N, 3 * l, m)),
          (p = r.Cartesian3.subtract(
            r.Cartesian3.fromArray(N, 3 * u, p),
            m,
            p
          )),
          (b = r.Cartesian3.subtract(
            r.Cartesian3.fromArray(N, 3 * (u - t), b),
            m,
            b
          )),
          (Y = r.Cartesian3.normalize(r.Cartesian3.add(p, b, Y), Y)),
          D(M, U, Y, z, void 0, e),
          (z += 3);
      } else {
        for (
          D(M, U, Y, z, void 0, e), z += 3, l = S, u = R, t = 0;
          t < s.length / 3;
          t++
        )
          (m = r.Cartesian3.fromArray(s, 3 * t, m)),
            ...
            (q[j++] = u + t),
            (q[j++] = u + t + 1),
            o.CorridorGeometryLibrary.addAttribute(N, m, z),
            (p = r.Cartesian3.fromArray(N, 3 * l, p)),
            (b = r.Cartesian3.fromArray(N, 3 * (u + t), b)),
            (Y = r.Cartesian3.normalize(r.Cartesian3.subtract(p, b, Y), Y)),
            D(M, U, Y, z, void 0, e),
            (z += 3);
        (m = r.Cartesian3.fromArray(N, 3 * l, m)),
          (p = r.Cartesian3.subtract(
            r.Cartesian3.fromArray(N, 3 * (u + t), p),
            m,
            p
          )),
          (b = r.Cartesian3.subtract(
            r.Cartesian3.fromArray(N, 3 * u, b),
            m,
            b
          )),
          (Y = r.Cartesian3.normalize(
            r.Cartesian3.negate(r.Cartesian3.add(b, p, Y), Y),
            Y
          )),
          D(M, U, Y, void 0, B, e),
          (B -= 3);
      ...
      for (
        ...
        (J = i.geodeticSurfaceNormal(r.Cartesian3.fromArray(Z, t, P), P)),
          (K = i.geodeticSurfaceNormal(r.Cartesian3.fromArray($, C - t, F), F)),
          (U = r.Cartesian3.normalize(r.Cartesian3.add(J, K, U), U)),
          D(M, U, Y, z, B, e),
          (R = z / 3),
          (I = R - 1),
    ...
    if (
      ((p.position = new s.GeometryAttribute({
      ...
      if (w) {
        ...
        const s = v / 2;
        for (h = s + 1; h < v + 1; h++)
          (n = a.CesiumMath.PI_OVER_TWO + o * h),
            (t[i++] = e * (1 + Math.cos(n))),
            (t[i++] = 0.5 * (1 + Math.sin(n)));
        for (h = 1; h < A - v + 1; h++) (t[i++] = h * e), (t[i++] = 0);
        for (h = v; h > s; h--)
          (n = a.CesiumMath.PI_OVER_TWO - h * o),
            (t[i++] = 1 - e * (1 + Math.cos(n))),
            (t[i++] = 0.5 * (1 + Math.sin(n)));
        for (h = s; h > 0; h--)
          (n = a.CesiumMath.PI_OVER_TWO - o * h),
            (t[i++] = 1 - r * (1 + Math.cos(n))),
            (t[i++] = 0.5 * (1 + Math.sin(n)));
        for (h = b - v; h > 0; h--) (t[i++] = h * r), (t[i++] = 1);
        for (h = 1; h < s + 1; h++)
          (n = a.CesiumMath.PI_OVER_TWO + o * h),
            (t[i++] = r * (1 + Math.cos(n))),
            (t[i++] = 0.5 * (1 + Math.sin(n)));
        ...
        for (
          b /= 3, A /= 3, r = 1 / (b - 1), e = 1 / (A - 1), h = 0;
          h < A;
          h++
        )
          (t[i++] = h * e), (t[i++] = 0);
        for (h = b; h > 0; h--) (t[i++] = (h - 1) * r), (t[i++] = 1);
      }
      p.st = new s.GeometryAttribute({
    ...
    return (
      e.normal &&
        (p.normal = new s.GeometryAttribute({
          componentDatatype: a.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: M.normals,
        })),
      e.tangent &&
        (p.tangent = new s.GeometryAttribute({
          componentDatatype: a.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: M.tangents,
        })),
      e.bitangent &&
        (p.bitangent = new s.GeometryAttribute({
          componentDatatype: a.ComponentDatatype.FLOAT,
          componentsPerAttribute: 3,
          values: M.bitangents,
        })),
  ...
  function I(t, e) {
    const i = new m.VertexFormat({
      ...
      l = t.ellipsoid,
      f = M(o.CorridorGeometryLibrary.computePositions(t), i, l),
      y = t.height,
      p = t.extrudedHeight;
    let g = f.attributes;
    const h = f.indices;
    ...
    (C = c.PolygonPipeline.scaleToGeodeticHeight(C, y, l)),
      ...
      (g = (function (t, e) {
        ...
        if (e.normal || e.bitangent || e.tangent) {
          ...
          if (
            (e.bitangent
              ? (m.set(n), m.set(n, l), (t.bitangent.values = m))
              : (t.bitangent = void 0),
            e.tangent)
          ) {
  ...
  function W(e, a, o, s, l) {
    ...
    if (
      ...
      r.Cartesian3.subtract(t, d[1], z),
        ...
        r.Cartesian3.multiplyByScalar(z, c, z),
    ...
    for (let t = 0; t < u - 1; ++t) H(d[t], d[t + 1], a, c, U, Y);
    const y = d[u - 1];
    r.Cartesian3.subtract(y, d[u - 2], z),
      ...
      s === i.CornerType.ROUNDED &&
        ...
        (Y.latitude = Math.max(Y.latitude, m)),
        (Y.longitude = Math.max(Y.longitude, f)));
    const p = n.defined(l) ? l : new r.Rectangle();
    return (
      (p.north = Y.latitude),
      (p.south = U.latitude),
      (p.east = Y.longitude),
  ...
  return (
    (q.unpack = function (t, e, a) {
      ...
      const l = m.VertexFormat.unpack(t, e, J);
      ...
      return n.defined(a)
        ? ((a._positions = o),
          ...
          (a._vertexFormat = m.VertexFormat.clone(l, a._vertexFormat)),
          (a._width = d),
          (a._height = u),
          (a._extrudedHeight = c),
          (a._cornerType = f),
    ...
    (q.createGeometry = function (i) {
      ...
      const y = i._height,
        p = i._extrudedHeight,
        g = !a.CesiumMath.equalsEpsilon(y, p, 0, a.CesiumMath.EPSILON2),
        h = i._vertexFormat,
        C = {
          ellipsoid: m,
          positions: f,
      ...
      if (g)
        ...
        if (
          ((b = M(o.CorridorGeometryLibrary.computePositions(C), h, m)),
          ...
          const t =
            ...
            e = b.attributes.position.values.length,
            r = new Uint8Array(e / 3).fill(t);
          b.attributes.applyOffset = new s.GeometryAttribute({
            componentDatatype: a.ComponentDatatype.UNSIGNED_BYTE,
            componentsPerAttribute: 1,
            values: r,
          });
      ...
      return (
        h.position || (b.attributes.position.values = void 0),
        new s.Geometry({
          attributes: A,
          indices: b.indices,
