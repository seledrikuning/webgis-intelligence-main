...
define([
  ...
  const O = {
    ...
    textureSizeInBytes: function (_, R, t, A) {
      let e = O.componentsLength(_);
      return T.isPacked(R) && (e = 1), e * T.sizeInBytes(R) * t * A;
    },
    alignmentInBytes: function (_, R, t) {
      const A = O.textureSizeInBytes(_, R, t, 1) % 4;
      return 0 === A ? 4 : 2 === A ? 2 : 1;
    },
    createTypedArray: function (_, R, t, A) {
      let e;
      ...
      e =
        n === Uint8Array.BYTES_PER_ELEMENT
          ...
          ? Float32Array
          : Uint32Array;
      return new e(O.componentsLength(_) * t * A);
    },
    flipY: function (_, R, t, A, e) {
      if (1 === e) return _;
      const T = O.createTypedArray(R, t, A, e),
    ...
    toInternalFormat: function (_, t, A) {
      if (!A.webgl2) return _;
        ...
        (this.dataFormatDescriptor = [
          {
            ...
            colorPrimaries: s.SRGB,
            transferFunction: s.SRGB,
  ...
  class o {
    ...
    _scan(_, R = 0) {
      ...
      let A = 0;
      for (; this._dataView.getUint8(this._offset) !== R && A < _; )
        A++, this._offset++;
      return (
        A < _ && this._offset++,
        new Uint8Array(this._dataView.buffer, this._dataView.byteOffset + t, A)
      );
    }
  }
  function a(_) {
  ...
  function L(R, A) {
    ...
    try {
      M = (function (_) {
        ...
        const t = new V(),
          ...
          e = new o(_, G.length, A, !0);
        (t.vkFormat = e._nextUint32()),
          (t.typeSize = e._nextUint32()),
          (t.pixelWidth = e._nextUint32()),
          (t.pixelHeight = e._nextUint32()),
          (t.pixelDepth = e._nextUint32()),
          (t.layerCount = e._nextUint32()),
          (t.faceCount = e._nextUint32());
        const T = e._nextUint32();
        t.supercompressionScheme = e._nextUint32();
        const O = e._nextUint32(),
          ...
          C = e._nextUint64(),
          K = e._nextUint64(),
          s = new o(_, G.length + A, 3 * T * 8, !0);
        for (let R = 0; R < T; R++)
          t.levels.push({
            levelData: new Uint8Array(
              _.buffer,
              _.byteOffset + s._nextUint64(),
              s._nextUint64()
            ),
            uncompressedByteLength: s._nextUint64(),
          });
        const F = new o(_, O, n, !0),
          N = {
        ...
        (t.dataFormatDescriptor.length = 0), t.dataFormatDescriptor.push(N);
        const i = new o(_, B, M, !0);
        for (; i._offset < M; ) {
          const _ = i._nextUint32(),
            R = i._scan(_),
            A = a(R),
            e = i._scan(_ - R.byteLength);
          (t.keyValue[A] = A.match(/^ktx/i) ? a(e) : e),
            i._offset % 4 && i._skip(4 - (i._offset % 4));
        }
        if (K <= 0) return t;
        const S = new o(_, C, K, !0),
          U = S._nextUint16(),
          E = S._nextUint16(),
          L = S._nextUint32(),
          P = S._nextUint32(),
        ...
        const l = C + S._offset,
          ...
          X = u + P,
          D = X + c,
          x = new Uint8Array(_.buffer, _.byteOffset + l, L),
          h = new Uint8Array(_.buffer, _.byteOffset + u, P),
          H = new Uint8Array(_.buffer, _.byteOffset + X, c),
          d = new Uint8Array(_.buffer, _.byteOffset + D, f);
        return (
          (t.globalData = {
            endpointCount: U,
            selectorCount: E,
    ...
    const C = M.dataFormatDescriptor[0],
      K = new Array(M.levelCount);
    return (
      0 !== M.vkFormat || (163 !== C.colorModel && 166 !== C.colorModel)
        ? (A.push(e.buffer),
          (function (R, t) {
            const A = R.vkFormat === B.VK_FORMAT_R8G8B8_SRGB ? n.RGB : n.RGBA;
            let e;
            R.vkFormat === B.VK_FORMAT_R8G8B8A8_UNORM
              ? (e = T.UNSIGNED_BYTE)
              : R.vkFormat === B.VK_FORMAT_R16G16B16A16_SFLOAT
              ? (e = T.HALF_FLOAT)
              : R.vkFormat === B.VK_FORMAT_R32G32B32A32_SFLOAT && (e = T.FLOAT);
            for (let O = 0; O < R.levels.length; ++O) {
              ...
              const G = R.levels[O].levelData,
                M = R.pixelWidth >> O,
                C = R.pixelHeight >> O,
                K = M * C * n.componentsLength(A);
              for (let t = 0; t < R.faceCount; ++t) {
                const O = G.byteOffset + K * R.typeSize * t;
                let n;
                (n =
                  _.defined(e) && 1 !== T.sizeInBytes(e)
                    ? 2 === T.sizeInBytes(e)
                      ? new Uint16Array(G.buffer, O, K)
                      : new Float32Array(G.buffer, O, K)
                    : new Uint8Array(G.buffer, O, K)),
                  (B[U[t]] = {
                    internalFormat: A,
                    datatype: e,
                    width: M,
        ...
        : (function (R, A, e, T, O, B) {
            ...
            let F, N;
            const r = A.dataFormatDescriptor[0],
              i = T.transcoder_texture_format;
            if (163 === r.colorModel)
              if (e.etc)
                (F = s ? n.RGBA8_ETC2_EAC : n.RGB8_ETC2),
                  (N = s ? i.cTFETC2_RGBA : i.cTFETC1_RGB);
              else if (e.etc1 && !s) (F = n.RGB_ETC1), (N = i.cTFETC1_RGB);
              else if (e.s3tc)
                (F = s ? n.RGBA_DXT5 : n.RGB_DXT1),
                  (N = s ? i.cTFBC3_RGBA : i.cTFBC1_RGB);
              else if (e.pvrtc)
                (F = s ? n.RGBA_PVRTC_4BPPV1 : n.RGB_PVRTC_4BPPV1),
                  (N = s ? i.cTFPVRTC1_4_RGBA : i.cTFPVRTC1_4_RGB);
              else if (e.astc) (F = n.RGBA_ASTC), (N = i.cTFASTC_4x4_RGBA);
              else {
                if (!e.bc7)
                  throw new t.RuntimeError(
                    "No transcoding format target available for ETC1S compressed ktx2."
                  );
                (F = n.RGBA_BC7), (N = i.cTFBC7_RGBA);
              }
            else if (166 === r.colorModel)
              if (e.astc) (F = n.RGBA_ASTC), (N = i.cTFASTC_4x4_RGBA);
              else if (e.bc7) (F = n.RGBA_BC7), (N = i.cTFBC7_RGBA);
              else if (e.s3tc)
                (F = s ? n.RGBA_DXT5 : n.RGB_DXT1),
                  (N = s ? i.cTFBC3_RGBA : i.cTFBC1_RGB);
              else if (e.etc)
            ...
            for (let R = 0; R < A.levels.length; ++R) {
              const e = {};
              (B[R] = e), (M = A.pixelWidth >> R), (C = A.pixelHeight >> R);
              const T = G.getImageTranscodedSizeInBytes(R, 0, 0, N.value),
                n = new Uint8Array(T),
                K = G.transcodeImage(n, R, 0, 0, N.value, 0, -1, -1);
              if (!_.defined(K))
  ...
  function P(_) {
    (E = _), E.initializeBasis(), (self.onmessage = A(L)), self.postMessage(!0);
  }
  return function (R) {
