  ...
  function l(t, h, u, o, l, r) {
    ...
    if (
      ...
      const i = s(l, t.latitude),
        e = s(l, M);
      (m = Math.tan(h) * (e - i)),
        (c = a.CesiumMath.negativePiToPi(t.longitude + m));
    } else {
      let i;
  ...
  Object.defineProperties(r.prototype, {
    ...
    (r.fromStartHeadingDistance = function (t, n, s, h, u) {
      const o = e.defaultValue(h, i.Ellipsoid.WGS84),
        ...
        m = c * c,
        g = Math.sqrt((M - m) / M),
        _ = l(t, (n = a.CesiumMath.negativePiToPi(n)), s, o.maximumRadius, g);
    ...
    (r.prototype.findIntersectionWithLongitude = function (t, n) {
      ...
      do {
        ...
        const t = s * Math.sin(M),
          i = (1 + t) / (1 - t);
        m =
          2 * Math.atan(d * Math.pow(i / c, s / 2)) - a.CesiumMath.PI_OVER_TWO;
      } while (!a.CesiumMath.equalsEpsilon(m, M, a.CesiumMath.EPSILON12));
      return (n.longitude = t), (n.latitude = m), (n.height = 0), n;
    }),
