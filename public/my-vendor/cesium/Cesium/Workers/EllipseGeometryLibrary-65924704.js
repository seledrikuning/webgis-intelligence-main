...
define([
  ...
  i.raisePositionsToHeight = function (t, e, n) {
    ...
    for (let e = 0; e < c; e += 3) {
      ...
      const M = a.Cartesian3.clone(x, y),
        ...
        z = a.Cartesian3.multiplyByScalar(f, r, u);
      a.Cartesian3.add(x, z, x),
        n &&
          (a.Cartesian3.multiplyByScalar(f, s, z),
          a.Cartesian3.add(M, z, M),
          (l[e + h] = M.x),
          (l[o + h] = M.y),
          (l[c + h] = M.z)),
        (l[e] = x.x),
  ...
  i.computeEllipsePositions = function (t, n, i) {
    ...
    for (
      ...
      if (
        ((V = c(I, o, w, O, f, d, z, _, p, V)),
        (A = c(Math.PI - I, o, w, O, f, d, z, _, p, A)),
        n)
      ) {
        for (
    ...
    for (v = P; v > 1; --v) {
      if (
        ((I = e.CesiumMath.PI_OVER_TWO - (v - 1) * T),
        (V = c(-I, o, w, O, f, d, z, _, p, V)),
        (A = c(I + Math.PI, o, w, O, f, d, z, _, p, A)),
        n)
      ) {
        for (
    ...
    (I = e.CesiumMath.PI_OVER_TWO), (V = c(-I, o, w, O, f, d, z, _, p, V));
    const N = {};
    return (
      n &&
        ((g[E++] = V.x),
