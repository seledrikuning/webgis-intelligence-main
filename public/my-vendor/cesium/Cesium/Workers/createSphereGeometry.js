...
define([
  ...
  const y = new i.EllipsoidGeometry(),
    G = {
      radius: void 0,
  ...
  return (
    (f.unpack = function (o, a, n) {
      const s = i.EllipsoidGeometry.unpack(o, a, y);
      return (
        (G.vertexFormat = r.VertexFormat.clone(
          s._vertexFormat,
          G.vertexFormat
        )),
        ...
        e.defined(n)
          ? (t.Cartesian3.clone(s._radii, G.radii),
            (n._ellipsoidGeometry = new i.EllipsoidGeometry(G)),
            n)
