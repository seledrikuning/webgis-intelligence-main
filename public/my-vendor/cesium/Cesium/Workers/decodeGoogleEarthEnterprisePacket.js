...
define([
    ...
    for (; f < d; )
      for (u = (u + 8) % 24, h = u; f < d && h < c; )
        a.setUint32(f, a.getUint32(f, !0) ^ s.getUint32(h, !0), !0),
          a.setUint32(
            f + 4,
            a.getUint32(f + 4, !0) ^ s.getUint32(h + 4, !0),
            !0
          ),
          (f += 8),
          (h += 24);
  ...
  var c = function (e, t, n, i) {
    ...
    k = function (e, t, n, i, r, a, o, s) {
      ...
      for (A = 1; A < T && 0 === P[A]; A++);
      for (U < A && (U = A), C = 1, B = 1; B <= u; B++)
        if (((C <<= 1), (C -= P[B]) < 0)) return -1;
      ...
      for (;;) {
        ...
        if (B > U && (z & h) !== c) {
          for (
            ...
            S++, (C <<= 1);
          if (((I += 1 << S), (1 === e && I > 852) || (2 === e && I > 592)))
            return 1;
          r[(c = z & h)] = (U << 24) | (S << 16) | (k - a) | 0;
        }
      }
      return (
        0 !== z && (r[k + z] = ((B - R) << 24) | (64 << 16) | 0),
        (s.bits = U),
        0
      );
    },
  ...
  function C(e) {
    if (R) {
      var t;
      for (U = new f.Buf32(512), S = new f.Buf32(32), t = 0; t < 144; )
        e.lens[t++] = 8;
      for (; t < 256; ) e.lens[t++] = 9;
      for (; t < 280; ) e.lens[t++] = 7;
      for (; t < 288; ) e.lens[t++] = 8;
      for (k(1, e.lens, 0, 288, U, 0, e.work, { bits: 9 }), t = 0; t < 32; )
        e.lens[t++] = 5;
  ...
  function I(e, t, n, i) {
    ...
    return (
      ...
      i >= a.wsize
        ? (f.arraySet(a.window, t, n - a.wsize, a.wsize, 0),
          (a.wnext = 0),
          (a.whave = a.wsize))
        : ((r = a.wsize - a.wnext) > i && (r = i),
          f.arraySet(a.window, t, n - i, r, a.wnext),
          (i -= r)
            ? (f.arraySet(a.window, t, n - i, i, 0),
              (a.wnext = i),
              (a.whave = a.wsize))
            : ((a.wnext += r),
  ...
  var z = {
      ...
      inflate: function (e, t) {
        ...
        e: for (;;)
          switch (n.mode) {
            ...
            case 19:
              for (; n.have < n.nlen + n.ndist; ) {
                for (
                  ;
                  (A =
                    ((O = n.lencode[u & ((1 << n.lenbits) - 1)]) >>> 16) & 255),
                    (T = 65535 & O),
                    !((E = O >>> 24) <= w);
            ...
            case 21:
              ...
              if (
                ((u >>>= E), (w -= E), (n.back += E), (n.length = T), 0 === A)
              ) {
                n.mode = 26;
                break;
              }
            ...
            case 23:
              for (
                ;
                (A =
                  ((O = n.distcode[u & ((1 << n.distbits) - 1)]) >>> 16) & 255),
                  (T = 65535 & O),
                  !((E = O >>> 24) <= w);
        ...
        return (
          ...
          (n.bits = w),
          (n.wsize ||
            (m !== e.avail_out && n.mode < y && (n.mode < 27 || 4 !== t))) &&
          ...
          n.wrap &&
            ...
            (e.adler = n.check =
              n.flags
                ? c(n.check, r, m, e.next_out - m)
                : l(n.check, r, m, e.next_out - m)),
          (e.data_type =
            n.bits +
            (n.last ? 64 : 0) +
            (n.mode === p ? 128 : 0) +
  ...
  var M = function (e) {
    ...
    H = function (e) {
      for (var t = new f.Buf8(e.length), n = 0, i = t.length; n < i; n++)
        t[n] = e.charCodeAt(n);
      return t;
    },
    N = function (e, t) {
  ...
  (ee.prototype.push = function (e, t) {
    ...
    do {
      if (
        ...
        (n = z.inflate(s, Y)) === q &&
          d &&
          (n = z.inflateSetDictionary(this.strm, d)),
        n === W && !0 === c && ((n = K), (c = !1)),
        n !== Q && n !== K)
      )
