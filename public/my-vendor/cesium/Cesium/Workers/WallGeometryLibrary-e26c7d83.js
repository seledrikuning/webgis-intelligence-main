...
define([
  ...
  a.computePositions = function (e, a, p, d, f, y) {
    const m = (function (e, o, r, a) {
      ...
      const g = n.defined(a),
        ...
        y = o[0];
      p[0] = y;
      const m = e.cartesianToCartographic(y, l);
      u && (m.height = r[0]), (d[0] = m.height), (f[0] = g ? a[0] : 0);
      let P = d[0] === f[0],
        A = 1;
      for (let t = 1; t < c; ++t) {
        const n = o[t],
      ...
      return P || A < 2
        ...
        : ((p.length = A),
          (d.length = A),
          (f.length = A),
          { positions: p, topHeights: d, bottomHeights: f });
    })(e, a, p, d);
    ...
    const P = a.length,
      A = P - 2;
    let C, w;
    const v = o.CesiumMath.chordLength(f, e.maximumRadius),
      b = u;
    if (((b.minDistance = v), (b.ellipsoid = e), y)) {
      let e,
        t = 0;
      for (e = 0; e < P - 1; e++)
      ...
      for (e = 0; e < P - 1; e++) {
        ...
        C.set(t, o),
          (n[0] = d[e]),
          (n[1] = d[e + 1]),
          w.set(r.PolylinePipeline.generateArc(b), o),
          (o += t.length);
      }
    } else
      (b.positions = a),
