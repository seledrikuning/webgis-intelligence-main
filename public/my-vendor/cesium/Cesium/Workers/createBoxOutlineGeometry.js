...
define([
...
], function (t, e, n, a, i, r, o, u, s, m, f) {
  "use strict";
  ...
  (d.fromDimensions = function (t) {
    ...
    (d.fromAxisAlignedBoundingBox = function (t) {
      return new d({ minimum: t.minimum, maximum: t.maximum });
    }),
    (d.packedLength = 2 * e.Cartesian3.packedLength + 1),
    (d.pack = function (t, n, i) {
      return (
  ...
  return (
    (d.unpack = function (t, n, i) {
      n = a.defaultValue(n, 0);
      const r = e.Cartesian3.unpack(t, n, p),
        o = e.Cartesian3.unpack(t, n + e.Cartesian3.packedLength, l),
        u = t[n + 2 * e.Cartesian3.packedLength];
      return a.defined(i)
        ? ((i._min = e.Cartesian3.clone(r, i._min)),
          (i._max = e.Cartesian3.clone(o, i._max)),
          (i._offsetAttribute = -1 === u ? void 0 : u),
          i)
        : ((y.offsetAttribute = -1 === u ? void 0 : u), new d(y));
    }),
    (d.createGeometry = function (u) {
      const s = u._min,
        m = u._max;
      ...
      (p[0] = s.x),
        ...
        (d[22] = 3),
        (d[23] = 7);
      const l = e.Cartesian3.subtract(m, s, c),
        y = 0.5 * e.Cartesian3.magnitude(l);
      if (a.defined(u._offsetAttribute)) {
        const t = p.length,
          e = u._offsetAttribute === o.GeometryOffsetAttribute.NONE ? 0 : 1,
      ...
      return new i.Geometry({
        ...
        offsetAttribute: u._offsetAttribute,
      });
    }),
    function (t, e) {
      return a.defined(e) && (t = d.unpack(t, e)), d.createGeometry(t);
    }
  );
});
