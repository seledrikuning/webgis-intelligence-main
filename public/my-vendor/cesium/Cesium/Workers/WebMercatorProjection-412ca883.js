  ...
  Object.defineProperties(a.prototype, {
    ...
    (a.prototype.project = function (t, o) {
      const n = this._semimajorAxis,
        r = t.longitude * n,
        u = a.geodeticLatitudeToMercatorAngle(t.latitude) * n,
        d = t.height;
      return i.defined(o)
        ? ((o.x = r), (o.y = u), (o.z = d), o)
        : new e.Cartesian3(r, u, d);
    }),
    (a.prototype.unproject = function (t, o) {
      const n = this._oneOverSemimajorAxis,
        r = t.x * n,
        u = a.mercatorAngleToGeodeticLatitude(t.y * n),
        d = t.z;
      return i.defined(o)
        ? ((o.longitude = r), (o.latitude = u), (o.height = d), o)
        : new e.Cartographic(r, u, d);
    }),
