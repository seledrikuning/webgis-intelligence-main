...
define([
  ...
  (a.fromCorners = function (e, i, m) {
    return (
      t.defined(m) || (m = new a()),
      (m.minimum = n.Cartesian3.clone(e, m.minimum)),
      (m.maximum = n.Cartesian3.clone(i, m.maximum)),
      (m.center = n.Cartesian3.midpoint(e, i, m.center)),
      m
    );
  }),
    (a.fromPoints = function (e, i) {
      if ((t.defined(i) || (i = new a()), !t.defined(e) || 0 === e.length))
        return (
      ...
      return (
        ...
        (d.y = c),
        (d.z = o),
        (i.center = n.Cartesian3.midpoint(f, d, i.center)),
        i
      );
    }),
      ...
      if (t.defined(e))
        return t.defined(i)
          ? ((i.minimum = n.Cartesian3.clone(e.minimum, i.minimum)),
            ...
            i)
          : new a(e.minimum, e.maximum, e.center);
    }),
    (a.equals = function (e, i) {
      return (
        e === i ||
        (t.defined(e) &&
          t.defined(i) &&
  ...
  let m = new n.Cartesian3();
  (a.intersectPlane = function (e, t) {
    m = n.Cartesian3.subtract(e.maximum, e.minimum, m);
    const a = n.Cartesian3.multiplyByScalar(m, 0.5, m),
      r = t.normal,
      s = a.x * Math.abs(r.x) + a.y * Math.abs(r.y) + a.z * Math.abs(r.z),
      u = n.Cartesian3.dot(e.center, r) + t.distance;
    return u - s > 0
      ? i.Intersect.INSIDE
      : u + s < 0
      ? i.Intersect.OUTSIDE
