...
define([
  ...
  function b(t) {
    const e = (t = o.defaultValue(t, o.defaultValue.EMPTY_OBJECT)).length,
      i = t.topRadius,
      n = t.bottomRadius,
      r = o.defaultValue(t.slices, 128),
      a = Math.max(o.defaultValue(t.numberOfVerticalLines, 16), 0);
    (this._length = e),
      (this._topRadius = i),
  ...
  return (
    ...
    (b.createGeometry = function (f) {
      let d = f._length;
      const c = f._topRadius,
        l = f._bottomRadius,
        b = f._slices,
        p = f._numberOfVerticalLines;
      if (d <= 0 || c < 0 || l < 0 || (0 === c && 0 === l)) return;
      const y = 2 * b,
        _ = n.CylinderGeometryLibrary.computePositions(d, c, l, b, !1);
      let h,
        A = 2 * b;
      if (p > 0) {
      ...
      const R = u.IndexDatatype.createTypedArray(y, 2 * A);
      let G,
        O = 0;
      for (G = 0; G < b - 1; G++)
      ...
      (V.position = new r.GeometryAttribute({
      ...
      const L = new t.BoundingSphere(
        e.Cartesian3.ZERO,
        e.Cartesian2.magnitude(m)
      );
      if (o.defined(f._offsetAttribute)) {
        d = _.length;
        const t = f._offsetAttribute === s.GeometryOffsetAttribute.NONE ? 0 : 1,
          e = new Uint8Array(d / 3).fill(t);
        V.applyOffset = new r.GeometryAttribute({
      ...
      return new r.Geometry({
        ...
        boundingSphere: L,
        offsetAttribute: f._offsetAttribute,
      });
    }),
    function (t, e) {
      return o.defined(e) && (t = b.unpack(t, e)), b.createGeometry(t);
    }
  );
});
