...
define([
  ...
  "./PolygonGeometryLibrary-5f5d3c91",
  ...
  function Q(o) {
    const r = o.vertexFormat,
      ...
      d = e.defined(a.attributes.st) ? a.attributes.st.values : void 0;
    let p = c.length;
    const y = o.wall,
      m = o.top || y,
      g = o.bottom || y;
    if (r.st || r.normal || r.tangent || r.bitangent || s) {
      const u = o.boundingRectangle,
        h = o.tangentPlane,
        f = o.ellipsoid,
        b = o.stRotation,
      ...
      let x;
      r.normal &&
        (x = _ && m && !y ? a.attributes.normal.values : new Float32Array(p));
      ...
      m && g && ((Z = p / 2), (J = p / 3), (p /= 2));
      for (let i = 0; i < p; i += 3) {
        const a = t.Cartesian3.fromArray(c, i, W);
        if (r.st && !e.defined(d)) {
          let e = t.Matrix3.multiplyByVector(q, a, V);
          e = f.scaleToGeodeticSurface(e, e);
          const o = h.projectPointOntoPlane(e, z);
          t.Cartesian2.subtract(o, P, o);
          const r = n.CesiumMath.clamp(o.x / u.width, 0, 1),
            i = n.CesiumMath.clamp(o.y / u.height, 0, 1);
          g && ((C[A + J] = r), (C[A + 1 + J] = i)),
            m && ((C[A] = r), (C[A + 1] = i)),
            (A += 2);
        }
        if (r.normal || r.tangent || r.bitangent || s) {
          ...
          if (y) {
            if (i + 3 < p) {
              const e = t.Cartesian3.fromArray(c, i + 3, F);
              if (Q) {
                const o = t.Cartesian3.fromArray(c, i + p, R);
                _ && O(a, e, o, f),
              ...
              t.Cartesian3.equalsEpsilon(e, a, n.CesiumMath.EPSILON10) &&
                (Q = !0);
            }
            (r.tangent || r.bitangent) &&
              ((L = f.geodeticSurfaceNormal(a, L)),
              r.tangent &&
                (G = t.Cartesian3.normalize(t.Cartesian3.cross(L, E, G), G)));
          } else
            (E = f.geodeticSurfaceNormal(a, E)),
              (r.tangent || r.bitangent) &&
                (_ &&
          ...
          r.normal &&
            (o.wall
              ? ((x[v + Z] = E.x), (x[e + Z] = E.y), (x[l + Z] = E.z))
              : g && ((x[v + Z] = -E.x), (x[e + Z] = -E.y), (x[l + Z] = -E.z)),
            ((m && !_) || y) && ((x[v] = E.x), (x[e] = E.y), (x[l] = E.z))),
            s &&
              (y && (E = f.geodeticSurfaceNormal(a, E)),
              (I[v + Z] = -E.x),
              (I[e + Z] = -E.y),
              (I[l + Z] = -E.z)),
            r.tangent &&
              (o.wall
                ? ((w[v + Z] = G.x), (w[e + Z] = G.y), (w[l + Z] = G.z))
                : g &&
                  ((w[v + Z] = -G.x), (w[e + Z] = -G.y), (w[l + Z] = -G.z)),
              m &&
                (_
                  ? ((w[v] = S.x), (w[e] = S.y), (w[l] = S.z))
                  : ((w[v] = G.x), (w[e] = G.y), (w[l] = G.z)))),
            r.bitangent &&
              (g && ((T[v + Z] = L.x), (T[e + Z] = L.y), (T[l + Z] = L.z)),
              m &&
                (_
                  ? ((T[v] = B.x), (T[e] = B.y), (T[l] = B.z))
                  : ((T[v] = L.x), (T[e] = L.y), (T[l] = L.z)))),
            (v += 3);
        }
      }
      r.st &&
        !e.defined(d) &&
        (a.attributes.st = new l.GeometryAttribute({
          componentDatatype: n.ComponentDatatype.FLOAT,
          componentsPerAttribute: 2,
          values: C,
        })),
        r.normal &&
          (a.attributes.normal = new l.GeometryAttribute({
            componentDatatype: n.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: x,
          })),
        r.tangent &&
          (a.attributes.tangent = new l.GeometryAttribute({
            componentDatatype: n.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: w,
          })),
        r.bitangent &&
          (a.attributes.bitangent = new l.GeometryAttribute({
            componentDatatype: n.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: T,
          })),
        s &&
          (a.attributes.extrudeDirection = new l.GeometryAttribute({
            componentDatatype: n.ComponentDatatype.FLOAT,
            componentsPerAttribute: 3,
            values: I,
          }));
    ...
    if (o.extrude && e.defined(o.offsetAttribute)) {
      ...
      if (o.offsetAttribute === u.GeometryOffsetAttribute.TOP)
        ...
        const e = o.offsetAttribute === u.GeometryOffsetAttribute.NONE ? 0 : 1;
        t = t.fill(e);
      }
  ...
  let J = new a.EllipsoidGeodesic();
  function X(r, i, s, l, c) {
    if (
      ((c = e.defaultValue(c, new t.Rectangle())),
      !e.defined(r) || r.length < 3)
    )
      return (c.west = 0), (c.north = 0), (c.south = 0), (c.east = 0), c;
    if (s === o.ArcType.RHUMB) return t.Rectangle.fromCartesianArray(r, i, c);
    J.ellipsoid.equals(i) || (J = new a.EllipsoidGeodesic(void 0, void 0, i)),
    ...
    const u = 1 / n.CesiumMath.chordLength(l, i.maximumRadius),
      d = r.length;
    let p,
    ...
    return (
      ...
      c.east - c.west > Z.eastOverIDL - Z.westOverIDL &&
        ...
        c.east > n.CesiumMath.PI && (c.east = c.east - n.CesiumMath.TWO_PI),
        c.west > n.CesiumMath.PI && (c.west = c.west - n.CesiumMath.TWO_PI)),
      c
    );
  }
  ...
  function ee(e, t, o, r) {
    const i = e.surfaceDistance,
      a = Math.ceil(i * t),
      s = a > 0 ? i / (a - 1) : Number.POSITIVE_INFINITY;
    let l = 0;
    for (let t = 0; t < a; t++) {
      ...
      (o.west = Math.min(o.west, i)),
        ...
        (o.south = Math.min(o.south, a)),
        (o.north = Math.max(o.north, a));
      const c = i >= 0 ? i : i + n.CesiumMath.TWO_PI;
      (r.westOverIDL = Math.min(r.westOverIDL, c)),
        (r.eastOverIDL = Math.max(r.eastOverIDL, c));
    }
  }
  const te = [];
  function oe(t, o, r, i, n, a, l, u, d, g) {
    const h = { walls: [] };
    let f;
    if (l || u) {
      const n = y.PolygonGeometryLibrary.createGeometryFromPositions(
          t,
          o,
          r,
          i,
      ...
      if (l && u) {
        const t = s.concat(s);
        (b = t.length / 3),
          (_ = p.IndexDatatype.createTypedArray(b, 2 * m.length)),
          _.set(m);
        const o = m.length,
          i = b / 2;
        for (f = 0; f < o; f += 3) {
        ...
        for (
          b = s.length / 3,
            _ = p.IndexDatatype.createTypedArray(b, m.length),
            f = 0;
          f < m.length;
          f += 3
        )
          (_[f] = m[f + 2]), (_[f + 1] = m[f + 1]), (_[f + 2] = m[f]);
        n.indices = _;
      }
      h.topAndBottom = new c.GeometryInstance({ geometry: n });
    }
    let b = n.outerRing,
      _ = s.EllipsoidTangentPlane.fromPoints(b, t),
      P = _.projectPointsOntoPlane(b, te),
      C = m.PolygonPipeline.computeWindingOrder2D(P);
    C === m.WindingOrder.CLOCKWISE && (b = b.slice().reverse());
    let x = y.PolygonGeometryLibrary.computeWallGeometry(b, r, t, i, a, g);
    h.walls.push(new c.GeometryInstance({ geometry: x }));
    const w = n.holes;
    for (f = 0; f < w.length; f++) {
      let e = w[f];
      (_ = s.EllipsoidTangentPlane.fromPoints(e, t)),
        (P = _.projectPointsOntoPlane(e, te)),
        (C = m.PolygonPipeline.computeWindingOrder2D(P)),
        C === m.WindingOrder.COUNTER_CLOCKWISE && (e = e.slice().reverse()),
        (x = y.PolygonGeometryLibrary.computeWallGeometry(e, r, t, i, a, g)),
        h.walls.push(new c.GeometryInstance({ geometry: x }));
    }
    return h;
  }
  function re(r) {
    const i = r.polygonHierarchy,
      a = e.defaultValue(r.vertexFormat, g.VertexFormat.DEFAULT),
      s = e.defaultValue(r.ellipsoid, t.Ellipsoid.WGS84),
      l = e.defaultValue(r.granularity, n.CesiumMath.RADIANS_PER_DEGREE),
      c = e.defaultValue(r.stRotation, 0),
      u = r.textureCoordinates,
      d = e.defaultValue(r.perPositionHeight, !1),
      p = d && e.defined(r.extrudedHeight);
    let m = e.defaultValue(r.height, 0),
      h = e.defaultValue(r.extrudedHeight, m);
    if (!p) {
      const e = Math.max(m, h);
      (h = Math.min(m, h)), (m = e);
    }
    (this._vertexFormat = g.VertexFormat.clone(a)),
      ...
      (this.packedLength =
        y.PolygonGeometryLibrary.computeHierarchyPackedLength(i, t.Cartesian3) +
        t.Ellipsoid.packedLength +
        g.VertexFormat.packedLength +
        (u
          ? y.PolygonGeometryLibrary.computeHierarchyPackedLength(
              u,
              t.Cartesian2
            )
          : 1) +
  ...
  (re.fromPositions = function (t) {
    ...
    (re.pack = function (o, r, i) {
      return (
        ...
        (i = y.PolygonGeometryLibrary.packPolygonHierarchy(
          o._polygonHierarchy,
          r,
          i,
          t.Cartesian3
        ...
        g.VertexFormat.pack(o._vertexFormat, r, i),
        (i += g.VertexFormat.packedLength),
        (r[i++] = o._height),
  ...
  const ie = t.Ellipsoid.clone(t.Ellipsoid.UNIT_SPHERE),
    ne = new g.VertexFormat(),
    ae = { polygonHierarchy: {} };
  return (
    (re.unpack = function (o, r, i) {
      r = e.defaultValue(r, 0);
      const n = y.PolygonGeometryLibrary.unpackPolygonHierarchy(
        o,
        r,
        t.Cartesian3
      );
      ...
      const s = g.VertexFormat.unpack(o, r, ne);
      ...
      const l = o[r++],
        ...
        C =
          -1 === o[r]
            ? void 0
            : y.PolygonGeometryLibrary.unpackPolygonHierarchy(
                o,
                r,
                t.Cartesian2
              );
      ...
      return (
        ...
        (i._vertexFormat = g.VertexFormat.clone(s, i._vertexFormat)),
        (i._height = l),
        (i._extrudedHeight = c),
        (i._granularity = u),
        (i._stRotation = d),
        (i._perPositionHeightExtrude = p),
        (i._perPositionHeight = m),
        (i._closeTop = h),
        (i._closeBottom = f),
        (i._shadowVolume = b),
    ...
    (re.computeRectangle = function (r, i) {
      const a = e.defaultValue(r.granularity, n.CesiumMath.RADIANS_PER_DEGREE),
        s = e.defaultValue(r.arcType, o.ArcType.GEODESIC),
        l = r.polygonHierarchy,
        c = e.defaultValue(r.ellipsoid, t.Ellipsoid.WGS84);
      return X(l.positions, c, s, a, i);
    }),
    (re.createGeometry = function (t) {
      ...
      const T = s.EllipsoidTangentPlane.fromPoints(w, r),
        I = y.PolygonGeometryLibrary.polygonsFromHierarchy(
          h,
          x,
        ...
        v = I.polygons,
        E = x
          ? y.PolygonGeometryLibrary.polygonsFromHierarchy(
              C,
              !0,
              function (e) {
                return e;
      ...
      w = A[0].outerRing;
      const G = y.PolygonGeometryLibrary.computeBoundingRectangle(
          T.plane.normal,
      ...
      if (
        ...
        !n.CesiumMath.equalsEpsilon(V, H, 0, n.CesiumMath.EPSILON2)
      )
        for (
          D.extrude = !0,
            D.top = b,
          ...
          const e = oe(r, v[N], x ? E[N] : void 0, a, A[N], f, b, _, o, P);
          let t;
          b && _
            ? ((t = e.topAndBottom),
              (D.geometry =
                y.PolygonGeometryLibrary.scaleToGeodeticHeightExtruded(
                  t.geometry,
                  V,
                  H,
                  r,
        ...
        for (N = 0; N < v.length; N++) {
          const i = new c.GeometryInstance({
            geometry: y.PolygonGeometryLibrary.createGeometryFromPositions(
              r,
              v[N],
              x ? E[N] : void 0,
              a,
          ...
          if (
            ...
            const e = i.geometry.attributes.position.values.length,
              o = t._offsetAttribute === u.GeometryOffsetAttribute.NONE ? 0 : 1,
              r = new Uint8Array(e / 3).fill(o);
            i.geometry.attributes.applyOffset = new l.GeometryAttribute({
              componentDatatype: n.ComponentDatatype.UNSIGNED_BYTE,
              componentsPerAttribute: 1,
              values: r,
            });
      ...
      const F = d.GeometryPipeline.combineInstances(O)[0];
      (F.attributes.position.values = new Float64Array(
        F.attributes.position.values
      )),
        (F.indices = p.IndexDatatype.createTypedArray(
            ...
            e.defined(this._textureCoordinateRotationPoints) ||
              (this._textureCoordinateRotationPoints = (function (e) {
                ...
                const o = e._ellipsoid,
                  ...
                  i = e.rectangle;
                return l.Geometry._textureCoordinateRotationPoints(r, t, o, i);
              })(this)),
