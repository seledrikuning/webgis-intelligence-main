...
define([
...
], function (e, t, n, i, o, a, l, r, s, p, c, d, u, y, f, g, h, m, E, _, P, b) {
  "use strict";
  function k(n) {
    const i = (n = e.defaultValue(n, e.defaultValue.EMPTY_OBJECT))
        .polylinePositions,
      o = n.shapePositions;
    (this._positions = i),
      (this._shape = o),
  ...
  k.pack = function (n, i, o) {
    ...
    const s = n._shape;
    for (
      r = s.length, i[o++] = r, a = 0;
      a < r;
      ++a, o += t.Cartesian2.packedLength
    )
  ...
  k.unpack = function (n, i, o) {
    ...
    let l = n[i++];
    const r = new Array(l);
    for (a = 0; a < l; ++a, i += t.Cartesian3.packedLength)
      r[a] = t.Cartesian3.unpack(n, i);
    l = n[i++];
    const s = new Array(l);
    for (a = 0; a < l; ++a, i += t.Cartesian2.packedLength)
      s[a] = t.Cartesian2.unpack(n, i);
  ...
  return (
    (k.createGeometry = function (e) {
      const d = e._positions,
        u = n.arrayRemoveDuplicates(d, t.Cartesian3.equalsEpsilon);
      let y = e._shape;
      if (
        ...
        return;
      c.PolygonPipeline.computeWindingOrder2D(y) === c.WindingOrder.CLOCKWISE &&
        y.reverse();
      const f = i.BoundingRectangle.fromPoints(y, T);
      return (function (e, t) {
        const n = new s.GeometryAttributes();
        n.position = new r.GeometryAttribute({
        ...
        const i = t.length,
          ...
          c = e.length / 3 / i,
          d = p.IndexDatatype.createTypedArray(l, 2 * i * (c + 1));
        let u,
          y,
          f = 0;
        u = 0;
        let g = u * i;
        for (y = 0; y < i - 1; y++) (d[f++] = y + g), (d[f++] = y + g + 1);
        for (
          d[f++] = i - 1 + g, d[f++] = g, u = c - 1, g = u * i, y = 0;
          y < i - 1;
          y++
        )
          (d[f++] = y + g), (d[f++] = y + g + 1);
        for (d[f++] = i - 1 + g, d[f++] = g, u = 0; u < c - 1; u++) {
          const e = i * u,
            t = e + i;
          for (y = 0; y < i; y++) (d[f++] = y + e), (d[f++] = y + t);
        }
        return new r.Geometry({
          attributes: n,
          indices: p.IndexDatatype.createTypedArray(l, d),
          boundingSphere: o.BoundingSphere.fromVertices(e),
          primitiveType: r.PrimitiveType.LINES,
        });
      })(l.PolylineVolumeGeometryLibrary.computePositions(u, y, f, e, !1), y);
    }),
    function (n, i) {
      return (
