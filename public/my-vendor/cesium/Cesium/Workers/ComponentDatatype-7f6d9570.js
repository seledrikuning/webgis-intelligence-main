...
define([
  ...
  (e.prototype.init_seed = function (t) {
    ...
    (e.prototype.init_by_array = function (t, n) {
      var r, e, a;
      for (
        this.init_seed(19650218), r = 1, e = 0, a = this.N > n ? this.N : n;
        a;
        a--
      ) {
      ...
      if (this.mti >= this.N) {
        ...
        for (; r < this.N - 1; r++)
          (t =
            ...
            (this.mt[r + 1] & this.LOWER_MASK)),
            (this.mt[r] =
              this.mt[r + (this.M - this.N)] ^ (t >>> 1) ^ n[1 & t]);
        (t =
  ...
  (i.sign = n.defaultValue(Math.sign, function (t) {
    return 0 === (t = +t) || t != t ? t : t > 0 ? 1 : -1;
  })),
    (i.signNotZero = function (t) {
      return t < 0 ? -1 : 1;
    }),
    (i.toSNorm = function (t, r) {
      return (
        (r = n.defaultValue(r, 255)),
        Math.round((0.5 * i.clamp(t, -1, 1) + 0.5) * r)
      );
    }),
    (i.fromSNorm = function (t, r) {
      return (r = n.defaultValue(r, 255)), (i.clamp(t, 0, r) / r) * 2 - 1;
    }),
    (i.normalize = function (t, n, r) {
      return 0 === (r = Math.max(r - n, 0)) ? 0 : i.clamp((t - n) / r, 0, 1);
    }),
    (i.sinh = n.defaultValue(Math.sinh, function (t) {
      return (Math.exp(t) - Math.exp(-t)) / 2;
    })),
    (i.cosh = n.defaultValue(Math.cosh, function (t) {
      return (Math.exp(t) + Math.exp(-t)) / 2;
    })),
    (i.lerp = function (t, n, r) {
      return (1 - r) * t + r * n;
    }),
    (i.PI = Math.PI),
    ...
    (i.negativePiToPi = function (t) {
      return t >= -i.PI && t <= i.PI ? t : i.zeroToTwoPi(t + i.PI) - i.PI;
    }),
    (i.zeroToTwoPi = function (t) {
      if (t >= 0 && t <= i.TWO_PI) return t;
      const n = i.mod(t, i.TWO_PI);
      return Math.abs(n) < i.EPSILON14 && Math.abs(t) > i.EPSILON14
        ? i.TWO_PI
        : n;
    }),
    (i.mod = function (t, n) {
      return i.sign(t) === i.sign(n) && Math.abs(t) < Math.abs(n)
        ? t
        : ((t % n) + n) % n;
    }),
    (i.equalsEpsilon = function (t, r, e, a) {
      (e = n.defaultValue(e, 0)), (a = n.defaultValue(a, e));
      const i = Math.abs(t - r);
      return i <= a || i <= e * Math.max(Math.abs(t), Math.abs(r));
    }),
    (i.lessThan = function (t, n, r) {
      return t - n < -r;
    }),
    (i.lessThanOrEquals = function (t, n, r) {
      return t - n < r;
    }),
    (i.greaterThan = function (t, n, r) {
      return t - n > r;
    }),
    (i.greaterThanOrEquals = function (t, n, r) {
      return t - n > -r;
    });
  const s = [1];
  (i.factorial = function (t) {
    ...
    (i.incrementWrap = function (t, r, e) {
      return (e = n.defaultValue(e, 0)), ++t > r && (t = e), t;
    }),
    ...
    (i.previousPowerOfTwo = function (t) {
      return (
        (t |= t >> 1),
        (t |= t >> 2),
        (t |= t >> 4),
  ...
  (i.setRandomNumberSeed = function (t) {
    ...
    (i.randomBetween = function (t, n) {
      return i.nextRandomNumber() * (n - t) + t;
    }),
    ...
    (i.chordLength = function (t, n) {
      return 2 * n * Math.sin(0.5 * t);
    }),
    (i.logBase = function (t, n) {
      return Math.log(t) / Math.log(n);
    }),
    (i.cbrt = n.defaultValue(Math.cbrt, function (t) {
      const n = Math.pow(Math.abs(t), 1 / 3);
      return t < 0 ? -n : n;
    })),
    (i.log2 = n.defaultValue(Math.log2, function (t) {
    ...
    (i.fastApproximateAtan = function (t) {
      return t * (-0.1784 * Math.abs(t) - 0.0663 * t * t + 1.0301);
    }),
    (i.fastApproximateAtan2 = function (t, n) {
      let r,
        e = Math.abs(t);
      r = Math.abs(n);
      const a = Math.max(e, r);
      r = Math.min(e, r);
      const s = r / a;
      return (
        (e = i.fastApproximateAtan(s)),
        (e = Math.abs(n) > Math.abs(t) ? i.PI_OVER_TWO - e : e),
        (e = t < 0 ? i.PI - e : e),
        (e = n < 0 ? -e : e),
        e
      );
  ...
  const E = {
    ...
    createArrayBufferView: function (t, r, e, a) {
      switch (
        ((e = n.defaultValue(e, 0)),
        (a = n.defaultValue(a, (r.byteLength - e) / E.getSizeInBytes(t))),
        t)
      ) {
        case E.BYTE:
          return new Int8Array(r, e, a);
        case E.UNSIGNED_BYTE:
          return new Uint8Array(r, e, a);
        case E.SHORT:
          return new Int16Array(r, e, a);
        case E.UNSIGNED_SHORT:
          return new Uint16Array(r, e, a);
        case E.INT:
          return new Int32Array(r, e, a);
        case E.UNSIGNED_INT:
          return new Uint32Array(r, e, a);
        case E.FLOAT:
          return new Float32Array(r, e, a);
        case E.DOUBLE:
          return new Float64Array(r, e, a);
      }
    },
    fromName: function (t) {
      switch (t) {
  ...
  var h = Object.freeze(E);
  (t.CesiumMath = u), (t.ComponentDatatype = h);
});
