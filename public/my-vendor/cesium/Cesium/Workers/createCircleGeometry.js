...
define([
  ...
  "./Plane-17fe9d66",
], function (e, t, i, r, o, n, s, l, a, d, m, c, u, p, y, _, G, x, f, h, g) {
  "use strict";
  function E(e) {
  ...
  (E.packedLength = i.EllipseGeometry.packedLength),
    (E.pack = function (e, t, r) {
      return i.EllipseGeometry.pack(e._ellipseGeometry, t, r);
    });
  const w = new i.EllipseGeometry({
  ...
  return (
    (E.unpack = function (o, n, s) {
      const l = i.EllipseGeometry.unpack(o, n, w);
      return (
        (A.center = e.Cartesian3.clone(l._center, A.center)),
        (A.ellipsoid = e.Ellipsoid.clone(l._ellipsoid, A.ellipsoid)),
        (A.height = l._height),
        (A.extrudedHeight = l._extrudedHeight),
        (A.granularity = l._granularity),
        (A.vertexFormat = r.VertexFormat.clone(
          l._vertexFormat,
          A.vertexFormat
        )),
        (A.stRotation = l._stRotation),
        (A.shadowVolume = l._shadowVolume),
        t.defined(s)
          ? ((A.semiMajorAxis = l._semiMajorAxis),
            (A.semiMinorAxis = l._semiMinorAxis),
            (s._ellipseGeometry = new i.EllipseGeometry(A)),
            s)
          : ((A.radius = l._semiMajorAxis), new E(A))
      );
    }),
