...
define([
  ...
  "./Plane-17fe9d66",
], function (e, i, t, n, o, s, a, r, l, m, d, u, c, p, f, h, g, y) {
  "use strict";
  ...
  const C = i.Ellipsoid.clone(i.Ellipsoid.UNIT_SPHERE),
    b = {
      positions: void 0,
  ...
  return (
    (H.unpack = function (t, n, o) {
      ...
      let a = t[n++];
      const r = new Array(a);
      for (s = 0; s < a; ++s, n += i.Cartesian3.packedLength)
        r[s] = i.Cartesian3.unpack(t, n);
      let l, m;
      if (((a = t[n++]), a > 0))
        for (l = new Array(a), s = 0; s < a; ++s) l[s] = t[n++];
      if (((a = t[n++]), a > 0))
        for (m = new Array(a), s = 0; s < a; ++s) m[s] = t[n++];
      const d = i.Ellipsoid.unpack(t, n, C),
    ...
    (H.fromConstantHeights = function (i) {
      ...
      if (r || l) {
        ...
        for (let i = 0; i < e; ++i) r && (n[i] = s), l && (o[i] = a);
      }
      return new H({
        positions: t,
        maximumHeights: o,
    ...
    (H.createGeometry = function (l) {
      const m = l._positions,
        d = l._minimumHeights,
        u = l._maximumHeights,
        c = l._granularity,
        p = l._ellipsoid,
        f = r.WallGeometryLibrary.computePositions(p, m, u, d, c, !1);
      ...
      const k = new s.GeometryAttributes({
        ...
        w = H / 3;
      H = 2 * w - 4 + w;
      const x = a.IndexDatatype.createTypedArray(w, H);
      let G = 0;
      for (b = 0; b < w - 2; b += 2) {
        const e = b,
          t = b + 2,
          o = i.Cartesian3.fromArray(C, 3 * e, _),
          s = i.Cartesian3.fromArray(C, 3 * t, E);
        if (i.Cartesian3.equalsEpsilon(o, s, n.CesiumMath.EPSILON10)) continue;
        const a = b + 1,
          r = b + 3;
        (x[G++] = a),
          (x[G++] = e),
